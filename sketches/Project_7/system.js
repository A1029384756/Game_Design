...
class RenderSprites extends System {
  ...
  work(r) {
    ...
    this.sprite_transforms.sort((a, b) => a.transform.pos.z - b.transform.pos.z).forEach(st => {
      ...
      game_controller.game_buffer.translate(createVector(this.pos.x + 10, this.pos.y + 10))
    ...
    particles.forEach(c => {
      let sprite = system_get_sprite(c)
      let transform = system_get_transform(c)
      game_controller.game_buffer.push()
      game_controller.game_buffer.translate(createVector(transform.pos.x + 10, transform.pos.y + 10))
      game_controller.game_buffer.rotate(transform.dir)
      game_controller.game_buffer.tint(sprite.tint)
      game_controller.game_buffer.image(sprite.imgs[sprite.curr_frame], -sprite.imgs[sprite.curr_frame].width / 2, -sprite.imgs[sprite.curr_frame].height / 2)
      game_controller.game_buffer.pop()
    })
